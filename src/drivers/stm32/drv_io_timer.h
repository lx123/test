...
#pragma once
__BEGIN_DECLS
/* configuration limits */   //配置极限
#define MAX_IO_TIMERS			4    //最大定时器数量
#define MAX_TIMER_IO_CHANNELS	8    //定时器通道数
#define IO_TIMER_ALL_MODES_CHANNELS 0

typedef enum io_timer_channel_mode_t {
	IOTimerChanMode_NotUsed = 0,    //不使用
	IOTimerChanMode_PWMOut  = 1,    //pwm输出
	IOTimerChanMode_PWMIn   = 2,    //pwm输入
	IOTimerChanMode_Capture = 3,    //pwm捕获
	IOTimerChanModeSize
