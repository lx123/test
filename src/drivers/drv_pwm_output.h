 ...
 */
#define PWM_OUTPUT_BASE_DEVICE_PATH "/dev/pwm_output"  //pwm输出及地址
 ...
 */
#define PWM_LOWEST_MIN 90  //pwm最小值，单位us

/**
 * Default value for a shutdown motor
 */
#define PWM_MOTOR_OFF	900   //关闭马达的默认值

/**
 * Default minimum PWM in us
 */
#define PWM_DEFAULT_MIN 1000  //默认的最小pwm，us
 ...
 */
#define PWM_HIGHEST_MAX 2150   //最高pwm

/**
 * Default maximum PWM in us
 */
#define PWM_DEFAULT_MAX 2000  //默认最大pwm
 ...
 */
struct pwm_output_rc_config {  //通道rc配置值
	uint8_t channel;
	uint16_t rc_min;
	uint16_t rc_trim;
	uint16_t rc_max;
